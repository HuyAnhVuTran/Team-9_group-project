...
MisinformationPlot = make_plot_component(
    {
         "Bot Misinformation Reproduction Rate (Strain 1)": "#FF0000",  # Red
        "Bot Misinformation Reproduction Rate (Strain 2)": "#FF88DC",  # Dark Red
        "Bot Misinformation Reproduction Rate (Strain 3)": "#99EDCC",  # Darker Red
    }
)
...
page = SolaraViz(
    model,
    components=[SpacePlot, StatePlot, InfectionPlot, MisinformationPlot],
